...
Do While rs1.EOF = False
    If (rs1.Fields("FCLASS").Value = "11" And rs1.Fields("FSUBJECT") = "PHYSICS") Then
...
rs1.MoveFirst
Do While rs1.EOF = False
    If (rs1.Fields("FCLASS").Value = "11" And rs1.Fields("FSUBJECT") = "CHEMISTRY") Then
...
Do While rs1.EOF = False
    ...
    rs1.MoveFirst
Do While rs1.EOF = False
    If (rs1.Fields("FCLASS").Value = "11" And rs1.Fields("FSUBJECT") = "COMPUTER SCIENCE") Then
...
rs1.MoveFirst
Do While rs1.EOF = False
    If (rs1.Fields("FCLASS").Value = "12" And rs1.Fields("FSUBJECT") = "PHYSICS") Then
    Combo11.AddItem (rs1.Fields("FNAME"))
...
rs1.MoveFirst
Do While rs1.EOF = False
    If (rs1.Fields("FCLASS").Value = "12" And rs1.Fields("FSUBJECT") = "CHEMISTRY") Then
...
Do While rs1.EOF = False
    ...
    rs1.MoveFirst
Do While rs1.EOF = False
    If (rs1.Fields("FCLASS").Value = "12" And rs1.Fields("FSUBJECT") = "COMPUTER SCIENCE") Then
